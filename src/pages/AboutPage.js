...
const AboutPage = ({ loc }) => {
    const L = loc === 'en' ? {
        ...
        mission: 'Our Mission',
        missionText: 'Subasti connects buyers and sellers across Costa Rica through secure escrow: payments are held until buyers receive their items and confirm satisfaction. Fixed-price sales, live auctions, and local pickup — all with eBay-style protection built for Costa Rica.',
        story: 'Our Story',
        ...
        missionText: 'Subasti conecta compradores y vendedores en Costa Rica con depósito en garantía: los pagos se retienen hasta que el comprador recibe y confirma conformidad. Ventas a precio fijo, subastas y recogida local — con protección estilo eBay para Costa Rica.',
